/**
 * Hausa — INTENTIONALLY EMPTY for now.
 *
 * The switcher (Onboarding step 2, Profile → Language) already lists Hausa
 * as a selectable option, and every key here falls back to English
 * automatically (see LanguageProvider's `t()` in ./context.tsx) — so
 * selecting Hausa today is safe, just not yet translated.
 *
